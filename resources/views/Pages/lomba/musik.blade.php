...
<div class="welcome">
    <div class="container">
        <div class="row row-lomba py-5 justify-content-center">
            <h1 class="text-center text-white pt-5" style="font-family: 'Odibee Sans', cursive;">COVER MUSIC</h1>
            
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 pt-5">
                        <h4 class="text-center w-100 text-white">
                            <img src="{{ asset('img/cover music.png') }}" alt="PUBG" width="100%">
                        </h4>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6 pt-5">
                        <h4 class="text-white fs-5 opacity-75" style="text-align: justify">Cover musik adalah lagu yang dibawakan oleh penyanyi atau instrumentalis yang bukan penyanyi atau instrumentalis original lagu tersebut
                            <br>
                            <br>
                            <b>TELSCUP</b> sedang mengadakan kompetisi dan membuka pendaftaran untuk lomba <b>Cover Music</b>. 
                            <br>
                            <br>
                            <table>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-6">35K per ORANG atau TIM</td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-3 pt-5">
                        <h4 class="text-center w-100 text-white">
                            ...
                            <a href="{{ route('pendaftaran_musik') }}" class="btn w-100 mt-3 btn-masuk">Daftar Sekarang</a>
                        </h4>
                    </div>
                </div>
            </div>

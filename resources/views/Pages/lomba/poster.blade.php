...
<div class="welcome">
    <div class="container">
        <div class="row row-lomba py-5 justify-content-center">
            <h1 class="text-center text-white pt-5" style="font-family: 'Odibee Sans', cursive;">DESAIN POSTER</h1>
            
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 pt-5">
                        <h4 class="text-center w-100 text-white">
                            <img src="{{ asset('img/desain poster.png') }}" alt="PUBG" width="100%">
                        </h4>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6 pt-5">
                        <h4 class="text-white fs-5 opacity-75" style="text-align: justify">Poster adalah sarana yang efektif bagi kamu yang ingin promosi atau menyampaikan suatu pesan dengan lantang karena ukurannya yang mudah menarik perhatian masyarakat luas. Dengan adanya kegiatan mendesain poster maka informasi tersebut akan lebih mudah di pahami dan lebih menarik perhatian, apabila poster didesain dengan seperti itu maka poster bisa menjadi pilihan tepat
                            <br>
                            <br>
                            <b>TELSCUP</b> sedang mengadakan kompetisi dan membuka pendaftaran untuk lomba <b>Desain Poster</b>. 
                            <br>
                            <br>
                            <table>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-md-1">:</td>
                                    <td class="col-md-6">50K per ORANG</td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-3 pt-5">
                        <h4 class="text-center w-100 text-white">
                            ...
                            <a href="{{ route('pendaftaran_poster') }}" class="btn w-100 mt-3 btn-masuk">Daftar Sekarang</a>
                        </h4>
                    </div>
                </div>
            </div>

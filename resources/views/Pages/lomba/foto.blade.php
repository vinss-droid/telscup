...
<div class="welcome">
    <div class="container">
        <div class="row row-lomba py-5 justify-content-center">
            <h1 class="text-center text-white pt-5" style="font-family: 'Odibee Sans', cursive;">PHOTOGRAPHY</h1>
            
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 pt-5">
                        <h4 class="text-center w-100 text-white">
                            <img src="{{ asset('img/photography.png') }}" alt="PUBG" width="100%">
                        </h4>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6 pt-5">
                        <h4 class="text-white fs-5 opacity-75" style="text-align: justify">Photography atau dalam bahasa indonesia disebut dengan fotografi merupakan aktivitas mengambil gambar melalui kamera untuk menghasilkan karya seni dan bisa dinikmati baik diri sendiri atau publik. Maka dari itu, kegiatan fotografi memiliki banyak teknik yang bisa membantu dalam menghasilkan berbagai karya yang membuat orang tertarik untuk melihatnya.
                            <br>
                            <br>
                            <b>TELSCUP</b> sedang mengadakan kompetisi dan membuka pendaftaran untuk lomba <b>Photography (fotografi)</b>. 
                            <br>
                            <br>
                            <table>
                                <tr>
                                    ...
                                    <td class="col-md-6">Pemain merupakan Pelajar Aktif Sederajat (SMP/MTS & SMA/SMK/MA)</td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-3 pt-5">
                        <h4 class="text-center w-100 text-white">
                            ...
                            <a href="{{ route('pendaftaran_foto') }}" class="btn w-100 mt-3 btn-masuk">Daftar Sekarang</a>
                        </h4>
                    </div>
                </div>
            </div>
